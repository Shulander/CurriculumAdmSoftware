...
class Pessoa
{
	...
	function alteraDadosEducacionaisBD ($dadosEducacionais)
	{
		...
		$result = mysql_query($sql, $this->conexaoBD->getLink()); 
		if (!$result) {
    		return "Erro no alteraчуo dos dados educacionais!".mysql_error();
		} else {
			return "sucesso";
		}
	}
	...
	function alteraHabilidadesBD ($habilidades)
	{
		...
		$result = mysql_query($sql, $this->conexaoBD->getLink()); 
		if (!$result) {
    		return "Erro no alteraчуo das habilidades!".mysql_error();
		} else {
			return "sucesso";
		}
	}
	...
	function alteraPesquisaBD ($pesquisa)
	{
		...
		$result = mysql_query($sql, $this->conexaoBD->getLink()); 
		if (!$result) {
    		return "Erro no alteraчуo da pesquisa!".mysql_error();
		} else {
			return "sucesso";
		}
	}
