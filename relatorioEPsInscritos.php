<?php
	...
	echo "<h3>Relatório de EPs Inscritos</h3>";
	...
	$sql = "SELECT login.id, nome FROM pessoa,login WHERE login.id=pessoa.idLogin and login.tipo='intercambista' ORDER BY nome ASC";
